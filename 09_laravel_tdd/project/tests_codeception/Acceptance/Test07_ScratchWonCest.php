...
class Test07_ScratchWonCest
{
    public function scratchwontest(AcceptanceTester $I): void
    {
        ...
        $I->assertEquals($user_premium->scratches_left, 1);
