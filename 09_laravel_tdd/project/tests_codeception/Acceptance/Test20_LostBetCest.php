...
class Test20_LostBetCest
{
    public function betsTest(AcceptanceTester $I): void
    {
        ...
        $I->updateInDatabase('events', ['date' => '2023-01-02', 'score' => '0:2'], ['id' => $event2->id]);
        ...
        $I->see('Kupon przegrany');
        $I->seeInDatabase("bets", ['id' => $user->id, 'status' => '1', 'bet_result' => '0']);
    }
}
